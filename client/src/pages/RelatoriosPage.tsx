...
export default function RelatoriosPage({ condominioId }: RelatoriosPageProps) {
  ...
  const { data: ordensServicoData, isLoading: loadingOrdensServico } = trpc.ordensServico.list.useQuery(
    { condominioId: selectedCondominioId || 0 },
    { enabled: !!selectedCondominioId }
  );
  const ordensServico = (ordensServicoData as any)?.items || ordensServicoData;
  ...
  return (
    <div className="space-y-6 print:space-y-4">
      {/* Header */}
      <div data-tour="header-relatorios" className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
        <div>
          <h1 className="text-2xl font-serif font-bold text-foreground">Relatórios</h1>
        ...
        <div className="flex items-center gap-2">
          <FunctionTutorialButton tutorialId="relatorios" variant="compact" />
